...
int GigEclientProp::setpcIP(cq_uint32_t IP)
{
	memClientProp.pcIP=IP;
	return 0;
}
cq_uint32_t GigEclientProp::getpcIP()
{
	return memClientProp.pcIP;
}
int GigEclientProp::setcamIP(cq_uint32_t IP)
{
	memClientProp.camIP=IP;
	return 0;
}
cq_uint32_t GigEclientProp::getcamIP()
{
